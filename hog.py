...
def swap_strategy(score, opponent_score):
    ...
    """
    "*** YOUR CODE HERE ***"
    opponent_max = (int(max(str(opponent_score))) + 1)
    if (opponent_max + score) * 2 == opponent_score:
        return 0
    elif (opponent_max + score) / 2 == opponent_score:
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    #leave opponent with four sided dice
    #if four sided then return 4
    "*** YOUR CODE HERE ***"
    num_rolls = BASELINE_NUM_ROLLS
    max_opp = (int(max(str(opponent_score))) + 1)
    if (score + max_opp + opponent_score) % 7 == 0: 
        return 0
    elif score + max_opp >= 100:
        return 0
    elif (score + opponent_score) % 7 == 0: 
        return 4
    elif (opponent_score - score) > 20:
        return 6
    elif (max_opp + score) * 2 == opponent_score:
        return 0
    #elif (opponent_score - score) < 20: ; return 5
    else:
        return BASELINE_NUM_ROLLS # Replace this statement
